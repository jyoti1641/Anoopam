...
class _SahebjjiMaBoleSectionState extends State<SahebjjiMaBoleSection> {
  ...
  String? _currentPlayingAudioId; // To keep track of the currently playing audio
    ...
    try {
      if (_currentPlayingAudioId == audioId) {
        ...
        setState(() {
          ...
          _isPlaying = false; // Set to false initially, will be true when playback starts
        });
        ...
        children: [
          Row(
            children: [
              ...
              const Text(
                'Sahebjji Ma Bole Shree Hari Re',
                style: TextStyle(
                  color: Colors.black,
                  fontSize: 18,
          ...
          FutureBuilder<List<AudioItem>>(
            ...
            builder: (context, snapshot) {
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return const SizedBox(
                  height: 140,
                  child: Center(child: Text('No audio items found.')),
                );
              } else {
                      ...
                      return Padding(
                        ...
                        child: SizedBox(
                          ...
                          child: ContentCard(
                            ...
                            isPlaying: _currentPlayingAudioId == audioItem.audioID && _isPlaying, // Pass playing state
                            onPlay: () {
                              _playAudio(audioItem.audioURL, audioItem.audioID); // Pass audio URL and ID
                            },
                          ),
                        ),
                      );
