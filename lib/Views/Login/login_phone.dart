...
class _LoginScreenState extends State<LoginScreen2> {
  ...
  final List<Country> _countries = [
    Country(
        ...
        maxLength: 10), // India typically has 10 digits
    Country(
        name: 'US',
        code: 'US',
        dialCode: '+1',
        flagAsset: 'assets/flags/us.png',
        maxLength: 10), // US typically has 10 digits
    Country(
        name: 'UK',
        code: 'GB',
        dialCode: '+44',
        flagAsset: 'assets/flags/gb.png',
        maxLength: 10), // UK mobile numbers are typically 10 digits after 07
    Country(
        name: 'Ca',
        code: 'CA',
        dialCode: '+1',
        flagAsset: 'assets/flags/ca.png',
        maxLength: 10), // Canada typically has 10 digits
    Country(
        name: 'Au',
        code: 'AU',
        dialCode: '+61',
        ...
        maxLength:
            9), // Australia mobile numbers are typically 9 digits after 04
                  ...
                  children: [
                      ...
                      child: Container(
                        ...
                        child: DropdownButtonHideUnderline(
                          child: DropdownButtonFormField<Country>(
                            ...
                            hint: Text('loginPhone.selectCountryRegion'.tr()),
                            decoration: InputDecoration(
                              contentPadding: EdgeInsets.symmetric(
                                  vertical: 7, horizontal: 8),
                              border: InputBorder.none,
                              labelText: "loginPhone.countryRegion".tr(),
                            ...
                            items: _countries.map<DropdownMenuItem<Country>>(
                                (Country country) {
                    ...
                    Expanded(
                      ...
                      child: TextField(
                        ...
                        obscureText:
                            false, // Phone number is usually not obscured
                        textAlign: TextAlign.start,
                        maxLines: 1,
                        style: const TextStyle(
                          fontWeight: FontWeight.w400,
                        ...
                        decoration: InputDecoration(
                          ...
                          labelText: "loginPhone.phoneNumber".tr(),
                      ...
                      child: GestureDetector(
                        onTap: () {
                          ...
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                    LoginScreen1()), // Navigating to login_email.dart
                          );
                        },
                        child: Container(
