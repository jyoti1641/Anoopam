...
class _AudioPlayerScreenState extends State<AudioPlayerScreen> {
  ...
  MediaItem _createMediaItem(AudioModel song) {
    final durationInMilliseconds = _parseDuration(song.audioDuration??'').inMilliseconds;
        ...
        setState(() {
          if (sequenceState != null &&
            ...
            if (widget.songs.isNotEmpty &&
              ...
              _totalDuration =
                  _parseDuration(widget.songs[_currentSongIndex].audioDuration??'');
            }
          }
        });
      }
  ...
  void _initializePlaylistAndPlay() async {
    ...
    try {
      ...
      if (widget.songs.isNotEmpty &&
        ...
        setState(() {
          _totalDuration =
              _parseDuration(widget.songs[widget.initialIndex].audioDuration??'');
        });
      }
    } catch (e) {
          ...
          : Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  //   child: Image.network(
                  //     currentSong., // Using imageUrl from AudioModel
